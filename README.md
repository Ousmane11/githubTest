...
-He empezado aplicando las funcionalidades básicas. Investigué la API e hice las llamadas. 
-No hice la autenticación oauth de github, a falta de backend. Para poder hacer las llamadas, hay que hacer el autenticado básico, registrando tu usuario github en terminal:

Basic authentication
curl -u "username" https://api.github.com

Finalmente hice el styling con sass
